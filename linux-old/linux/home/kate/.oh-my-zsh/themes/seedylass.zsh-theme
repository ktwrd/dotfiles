...
#
# Most of this is based off another built-in zsh theme which I don't remember...
...
setopt prompt_subst
PROMPT="[${purple}%n%{$reset_color%}@%{$turquoise%}%M%{$reset_color%}] [${limegreen}%~%{$reset_color%}]\$(ruby_prompt_info)\$vcs_info_msg_0_${orange}%{$reset_color%} %{$new_line%}%{$orange%}λ%{$reset_color%} "

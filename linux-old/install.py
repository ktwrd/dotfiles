...
def _install_packages():
    ...
    if runinfo["packagemanager"] == "yum":
        package_install(["https://cdn.jyles.club/upload/ocs-url-3.1.0-1.rpm"], "ocs-url")
    if runinfo["packagemanager"] == "apt":
        subprocess.run(["/usr/bin/wget", "https://cdn.jyles.club/upload/ocs-url-3.1.0-1.deb"])
        package_install([
            "libqt5svg5",
    ...
    if runinfo["packagemanager"] == "zypper":
        ...
        subprocess.run(["/usr/bin/wget", "https://cdn.jyles.club/upload/ocs-url-3.1.0-1.rpm"])
